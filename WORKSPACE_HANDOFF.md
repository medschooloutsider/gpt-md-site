...
- 2026-04-29 gallery update: the four selected `12_02_* PM` images were identified as GPT-MD images and added as a no-title/no-caption gallery under the Introduction panel. Local checks confirmed four gallery images, no missing references, and no horizontal overflow.
